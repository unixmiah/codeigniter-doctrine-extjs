...
Doctrine_Manager::getInstance()->bindComponent('NoiseValue', 'moqold');
 ...
 */
abstract class BaseNoiseValue extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('noise_value');
        ...
        $this->hasColumn('noiseName', 'string', 45, array(
             'type' => 'string',
             'length' => 45,
             'fixed' => false,
             'unsigned' => false,
