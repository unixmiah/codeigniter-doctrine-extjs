...
Doctrine_Manager::getInstance()->bindComponent('AnimalValue', 'moqold');
 ...
 */
abstract class BaseAnimalValue extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('animal_value');
        ...
        $this->hasColumn('animalName', 'string', 45, array(
             'type' => 'string',
             'length' => 45,
             'fixed' => false,
             'unsigned' => false,
