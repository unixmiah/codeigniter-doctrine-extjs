...
Doctrine_Manager::getInstance()->bindComponent('ClientSpecialcondDetail', 'moqold');

/**
 * BaseClientSpecialcondDetail
 * 
 ...
 */
abstract class BaseClientSpecialcondDetail extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('client_specialcond_detail');
        ...
        $this->hasColumn('recDate', 'date', null, array(
             'type' => 'date',
             'fixed' => false,
             'unsigned' => false,
             'primary' => false,
