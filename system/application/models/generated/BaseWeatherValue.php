...
Doctrine_Manager::getInstance()->bindComponent('WeatherValue', 'moqold');
 ...
 */
abstract class BaseWeatherValue extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('weather_value');
        ...
        $this->hasColumn('weatherName', 'string', 45, array(
             'type' => 'string',
             'length' => 45,
             'fixed' => false,
             'unsigned' => false,
